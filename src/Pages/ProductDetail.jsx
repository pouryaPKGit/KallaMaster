...
import { products } from "../assets/Infoes";
...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    const shuffledProducts = productss.sort(() => Math.random() - 0.5).slice(0, 5);
  ...
  <p className="text-white pr-2">70%</p>
      ...
      {hoverText && (
        ...
        <div>
          ...
          <div className="bg-blue-600 text-white text-sm mt-3 w-[160px] h-[35px] px-1 rounded-2xl flex items-center justify-center gap-2">
          ...
          <div className="flex flex-wrap gap-10 items-center">
            ...
            <div className="pt-8" onClick={handleCartClick}>
              <button onClick={handleAddToCart} className="bg-blue-600 w-[200px] h-[40px] text-white rounded-md">افزودن به سبد خرید</button>
            </div>
            <div className="pt-8">
      <FaHeart
        className="bg-blue-600  h-[40px] w-[40px] text-xl text-white p-1 rounded-md cursor-pointer -mr-5"
      ...
      <ToastContainer />
        ...
        <div className="flex flex-col gap-3 items-center">
          <div className="border-[7px] border-blue-600 rounded-2xl p-2 h-[150px] w-[300px] flex flex-col gap-4 items-center justify-center">
      ...
      <span
        ...
        className={`bg-red-500 w-4 h-4 rounded-full cursor-pointer ${
      ...
      <span
        ...
        className={`bg-blue-500 w-4 h-4 rounded-full cursor-pointer ${
          selectedColor === 'blue' ? 'ring-4 ring-blue-300' : ''
        }`}
      ></span>
    </div>
            </div>
      ...
      <div className="min-h-[170px] w-[100%] mt-8 bg-white rounded-2xl m-auto pt-12">
        <div className="flex flex-wrap items-center gap-40 justify-center">
          <div className="flex flex-col items-center gap-2">
            <img src="/Images/Send/24-hours-pnntw9milw8mlqgx919fa7kn5688iyntkt780vwl84.png" className="w-[50px] h-[50px]" alt="" />
            <span>پشتیبان 24 ساعت</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <img src="/Images/Send/checked-pnnu7aaepzbmp6gqwspzifh5trx4r8ejrci4jnkgac.png" className="w-[50px] h-[50px]" alt="" />
            <span>تضمین اصالت کالا</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <img src="/Images/Send/free-delivery-pnnu4szqopxe282ge84ffk0de659fzk1r2izyd8upg (1).png" className="w-[50px] h-[50px]" alt="" />
            <span>دسترسی سریع</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <img src="/Images/Send/search-pnnueewcjr2wqq40adn4x4pzzysc4lp9qmlok6zz3o.png" alt="" className="w-[50px] h-[50px]" />
            <span>تضمین کیفیت کالا</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <img src="/Images/Send/secure-payment-pnnuf9x0ta9dduuy991tpew7lojg6m4euw4pebpzec.png" className="w-[50px] h-[50px]" alt="" />
      ...
      <div className="flex items-center gap-3">
  <div
    className={`cursor-pointer w-[120px] h-[100px] rounded-xl flex flex-col items-center justify-center tab-button ${activeTab === 'description' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800 shadow-lg'}`}
  ...
  <div
    className={`cursor-pointer w-[120px] h-[100px] rounded-xl flex flex-col items-center justify-center tab-button ${activeTab === 'reviews' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800 shadow-lg'}`}
  ...
  >
    ...
    <span>نظر کاربران</span>
      ...
      <div className="flex items-center gap-1">
        <TfiPencilAlt className="text-blue-600 text-xl" />
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 items-start rounded-md px-2 py-2">
        ...
        <div>
          <button type="submit" className="bg-blue-600 text-white rounded-md w-[66px] h-[45px]">
            ثبت
          </button>
        </div>
      </form>
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-14 gap-y-10 mx-auto mt-10">
