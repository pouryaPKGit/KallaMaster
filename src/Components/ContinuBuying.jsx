    ...
    <div className="flex h-screen flex-wrap gap-y-6 gap-x-10 items-start xs:justify-center px-10 my-10">
      <form action="">
        <div className="bg-white lg:w-[1000px] sm:w-[600px] xs:w-[400px] min-h-[85vh] pb-10 shadow-lg rounded-2xl ">
          <div className="flex items-center justify-center mt-3 bg-blue-500 text-white h-[50px] rounded-t-xl">
            <h1 className="">اطلاعات خودرا وارد نمایید</h1>
          </div>  
          <div className="flex flex-wrap justify-center px-10 gap-x-5 gap-y-8 pt-10 text-sm text-blue-400">
            <div>
              <span>نام:</span>
              <br />
      ...
      <div className="flex flex-col gap-y-5 pt-4">
        <div className="bg-white w-[350px] h-[350px] rounded-xl shadow-lg">
          <h1 className="bg-blue-500 rounded-t-xl h-[40px] text-white flex items-center justify-center text-sm">
            انتخاب تاریخ ارسال
          </h1>
            ...
            {days.map((day, index) => (
              <span
                ...
                className={`cursor-pointer hover:opacity-50 w-20 h-8 rounded-xl  flex items-center justify-center ${
                  selectedDay === day ? "bg-blue-600 text-white" : "bg-blue-400 text-white"
                }`}
              >
                {day}
              </span>
          ...
          <div className="flex items-center justify-center mt-5 h-[40px] w-[100%] m-auto  text-blue-500 text-sm">
              <h1 className="bg-blue-400 text-white rounded-xl p-3">انتخاب روش ارسال</h1>
            </div>
            <div className="flex flex-col text-sm pt-5">
              <span className="bg-blue-400 text-white cursor-pointer h-[30px] flex w-[80%] m-auto rounded-lg items-center justify-center hover:opacity-50">ارسال با پست</span>
              <span className="bg-blue-400 text-white cursor-pointer h-[30px] flex w-[80%] m-auto rounded-lg mt-3 items-center justify-center hover:opacity-50">ارسال با پست پیشتاز</span>
              
            </div>
        </div>

        <div className="bg-white w-[350px] h-[250px] rounded-xl shadow-lg">
          <h1 className="flex justify-center bg-blue-600 text-white rounded-t-xl h-[50px] items-center">
            محاسابت سبد خرید شما
          </h1>
          <div className="flex gap-10 justify-center text-md text-gray-700 pt-10">
            <div className="flex flex-col gap-3 items-start">
              <span className="text-blue-500">قیمت کل :</span>
          ...
          <div>
            <Link to="/continuBuying">
              <span className="text-white text-sm bg-blue-600 flex items-center justify-center w-[200px] h-[35px] hover:opacity-70 m-auto rounded-md mt-5 shadow-md cursor-pointer">
